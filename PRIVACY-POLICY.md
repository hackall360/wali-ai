# Privacy Policy for Wali Discord Bot

This privacy policy governs the use of the Discord bot Wali ("the Bot") developed by glazk0 ("the Developer"). This policy outlines the types of information collected, how it is used, and the choices available to users regarding the collection and use of their data.
